...
# Form implementation generated from reading ui file 'viewdependents.ui'
#
...
class Ui_ViewDependents(object):
    passedssn = -1
    VDep = None
    def __init__(self, obj):
        self.passedssn = obj.textEdit.text()

    def setupUi(self, ViewDependents):
        self.VDep = ViewDependents
        ViewDependents.setObjectName("ViewDependents")
        ViewDependents.resize(699, 433)
        self.buttonBox = QtWidgets.QDialogButtonBox(ViewDependents)
        self.buttonBox.setGeometry(QtCore.QRect(300, 360, 321, 31))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtWidgets.QDialogButtonBox.Close)
        self.buttonBox.setObjectName("buttonBox")
        self.verticalLayoutWidget = QtWidgets.QWidget(ViewDependents)
        ...
        self.retranslateUi(ViewDependents)
        self.buttonBox.rejected.connect(self.reject)
        QtCore.QMetaObject.connectSlotsByName(ViewDependents)
    ...
    def retranslateUi(self, ViewDependents):
        _translate = QtCore.QCoreApplication.translate
        ViewDependents.setWindowTitle(_translate("ViewDependents", "Dialog"))
        self.tabdependents.setSortingEnabled(True)
        item = self.tabdependents.horizontalHeaderItem(0)
        item.setText(_translate("ViewDependents", "Name"))
        item = self.tabdependents.horizontalHeaderItem(1)
        item.setText(_translate("ViewDependents", "Sex"))
        item = self.tabdependents.horizontalHeaderItem(2)
        item.setText(_translate("ViewDependents", "Date of Birth"))
        item = self.tabdependents.horizontalHeaderItem(3)
        item.setText(_translate("ViewDependents", "Relationship"))
        #self.gobutton.setText(_translate("ViewDependents", "Go"))
        self.label.setText(_translate("ViewDependents", "Emp SSN"))
        self.empname.setText(_translate("ViewDependents", "Emp Name"))
        self.label_6.setText(_translate("ViewDependents", "Dependent Count"))

    def select_data(self):
        try:
            db = mysql.connector.connect(option_files='mydb.conf')
            cursor = db.cursor()
            # Retrieve the name of employee associated with ssn value passed to function
            ...
            if nrows <= 0 :
                ...
                msg.exec()
                return
            # Retrieve data for dependents that correspond to ssn value from input
